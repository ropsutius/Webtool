...
(function (UTIF, pako) {
  ...
  (function () {
    ...
    (function () {
      ...
      function X(a, d, f, e, b, B, k, l, r) {
        ...
        var g =
            9 < arguments.length && void 0 !== arguments[9] ? arguments[9] : !1,
          u = f.P,
          v = d,
          z = 0,
          x = 0,
      ...
      function N(a, d) {
        var f =
            2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : d,
          e = a.length - 1;
        f = f < d ? f : d;
        if (d >= e) return null;
        var b = (a[d] << 8) | a[d + 1];
      ...
      for (dp = 0, col = 0; col < raw_width - 30; dp += 16) {
        ...
        for (bit = 30, i = 0; i < 16; i++)
          if (i == imax) pix[i] = max;
            ...
            pix[i] =
              (((bin.readUshort(data, dp + (bit >> 3)) >>> (bit & 7)) & 0x7f) <<
                sh) +
              min;
  ...
  UTIF.decode._decodeNikon = function (
    ...
    var nikon_tree = [
      [
        0, 0, 1, 5, 1, 1, 1, 1, 1, 1, 2, 0, 0, 0, 0, 0, 0 /* 12-bit lossy */, 5,
        4, 3, 6, 2, 7, 1, 0, 8, 9, 11, 10, 12,
      ],
      [
        0, 0, 1, 5, 1, 1, 1, 1, 1, 1, 2, 0, 0, 0, 0, 0,
        0 /* 12-bit lossy after split */, 0x39, 0x5a, 0x38, 0x27, 0x16, 5, 4, 3,
        2, 1, 0, 11, 12, 12,
      ],
      [
      ...
      [
        0, 0, 1, 4, 3, 1, 1, 1, 1, 1, 2, 0, 0, 0, 0, 0, 0 /* 14-bit lossy */, 5,
        6, 4, 7, 8, 3, 9, 2, 1, 0, 10, 11, 12, 13, 14,
      ],
      [
        0, 0, 1, 5, 1, 1, 1, 1, 1, 1, 1, 2, 0, 0, 0, 0,
        0 /* 14-bit lossy after split */, 8, 0x5c, 0x4b, 0x3a, 0x29, 7, 6, 5, 4,
        3, 2, 1, 0, 13, 14,
      ],
      [
  ...
  UTIF.decode._decodeLZW = (function () {
    var x = {},
      ...
      c = function (L, F, i, W) {
        if (!x.c) {
          var _ = new Uint32Array(65535),
            a = new Uint16Array(65535),
            Z = new Uint8Array(2e6);
          for (var f = 0; f < 256; f++) {
            Z[f << 2] = f;
            _[f] = f << 2;
            a[f] = 1;
